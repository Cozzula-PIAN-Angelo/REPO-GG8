...
for (let i = 0; i < starWarsCharacters.length; i++) {
   if (starWarsCharacters[i].gender === `female`) {
      ...
      personaggiFemminili.push(femaleName)
   }
}
...
const perColoreOcchi = { blue: [], yellow: [], brown: [], red: [], 'blue-gray': [], }
...
for (const persona of starWarsCharacters) {
   switch (persona.eye_color) {
      case 'blue':
         perColoreOcchi.blue.push(persona);
         break;
      case 'yellow':
         perColoreOcchi.yellow.push(persona);
         break;
      case 'brown':
         perColoreOcchi.brown.push(persona);
         break;
      case 'red':
         perColoreOcchi.red.push(persona);
         break;
      case 'blue-gray':
         perColoreOcchi["blue-gray"].push(persona);
         break;
   }
}
